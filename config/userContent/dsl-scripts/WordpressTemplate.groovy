...
'IMAGE_NAME_BASE=\"\${IMAGE_NAME_BASE%\"\${IMAGE_NAME_BASE##*[![:space:]]}\"}\";  # elimina los espacios por detras\n'+
...
'IMAGE_VERSION=\"\${IMAGE_VERSION%\"\${IMAGE_VERSION##*[![:space:]]}\"}\";  # elimina los espacios por detras\n'+
...
'                \\n LABEL com.serenity.image.version=\\\"0.\$BUILD_NUMBER-SNAPSHOT\\\" \\\n'+
...
'                \\n ENV com.serenity.image.version=\\\"0.\$BUILD_NUMBER-SNAPSHOT\\\" \"\n'+
'fi\n'+
        ...
        downstreamParameterized {
            trigger('wp-dev-ose3-deploy') {
                ...
                parameters {
                  ...
                  predefinedProp('OSE3_APP_NAME',PROJECT_NAME)
                }
            }
        }
    } //publishers
