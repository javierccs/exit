...
def CONFIGURATION_GIT_USER_DEV ="${CONFIGURATION_GIT_USER_DEV}".trim()
def CONFIGURATION_GIT_PASSWORD_DEV ="${CONFIGURATION_GIT_PASSWORD_DEV}".trim()
...
if (CONFIGURATION_GIT_USER_DEV != "") OTHER_OSE3_TEMPLATE_PARAMS_DEV+=",CONFIGURATION_GIT_USER="+CONFIGURATION_GIT_USER_DEV
if (CONFIGURATION_GIT_PASSWORD_DEV != "") OTHER_OSE3_TEMPLATE_PARAMS_DEV+=",CONFIGURATION_GIT_PASSWORD="+CONFIGURATION_GIT_PASSWORD_DEV
...
def CONFIGURATION_GIT_USER_PRE ="${CONFIGURATION_GIT_USER_PRE}".trim()
def CONFIGURATION_GIT_PASSWORD_PRE ="${CONFIGURATION_GIT_PASSWORD_PRE}".trim()
...
if (CONFIGURATION_GIT_USER_PRE != "") OTHER_OSE3_TEMPLATE_PARAMS_PRE+=",CONFIGURATION_GIT_USER="+CONFIGURATION_GIT_USER_PRE
if (CONFIGURATION_GIT_PASSWORD_PRE != "") OTHER_OSE3_TEMPLATE_PARAMS_PRE+=",CONFIGURATION_GIT_PASSWORD="+CONFIGURATION_GIT_PASSWORD_PRE
...
def CONFIGURATION_GIT_USER_PRO ="${CONFIGURATION_GIT_USER_PRO}".trim()
def CONFIGURATION_GIT_PASSWORD_PRO ="${CONFIGURATION_GIT_PASSWORD_PRO}".trim()
...
if (CONFIGURATION_GIT_USER_PRO != "") OTHER_OSE3_TEMPLATE_PARAMS_PRO+=",CONFIGURATION_GIT_USER="+CONFIGURATION_GIT_USER_PRO
if (CONFIGURATION_GIT_PASSWORD_PRO != "") OTHER_OSE3_TEMPLATE_PARAMS_PRO+=",CONFIGURATION_GIT_PASSWORD="+CONFIGURATION_GIT_PASSWORD_PRO
